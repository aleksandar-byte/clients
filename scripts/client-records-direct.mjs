...
const FIELD_TO_COLUMN = {
  ...
  "Homepage Meta Description": "homepage_meta_description",
  "Location": "location",
  "Industry": "industry",
  ...
  const statements = [
    ...
    sql`
      insert into core.clients (
        ...
        ${values.client},
        ${values.website},
        ${values.homepage_title},
        ${values.homepage_meta_description},
        ${values.location},
        ${values.industry},
      ...
      on conflict (client_key) do update set
        ...
        homepage_title = coalesce(nullif(excluded.homepage_title, ''), core.clients.homepage_title),
        homepage_meta_description = coalesce(nullif(excluded.homepage_meta_description, ''), core.clients.homepage_meta_description),
